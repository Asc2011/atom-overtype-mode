var CompositeDisposable, OvertypeMode, action, actions, cLevel, cmd, log, pkg, util,
...
cLevel = ['debug', 'log', 'info', 'warn', 'error'];

log = console.log;

util = {
  deepDiff: function(oldV, newV, path, diff) {
    var key, msg, val;
    if (path == null) {
      path = [];
    }
